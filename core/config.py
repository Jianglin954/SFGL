...
def set_cfg(cfg):
    ...
    cfg.gnn = CN()
    cfg.lm = CN()
    cfg.ratio = 100 # total used labeled samples in training set
    ...
    cfg.gnn.model = CN()
    # GNN model name
    cfg.gnn.model.name = 'GCN'  # 'RevGAT'   # 'SAGE' # 'GCN'
    ...
    cfg.gnn.train.weight_decay = 0.0005     # 0.0
    # Maximal number of epochs
    cfg.gnn.train.epochs = 200
    # Node feature type, options: ogb, TA, P, E
    cfg.gnn.train.feature_type = 'TA'  #'TA_P_E'
    # Number of epochs with no improvement after which training will be stopped
    cfg.gnn.train.early_stop = 500
    # Base learning rate
    cfg.gnn.train.lr = 0.001
    # L2 regularization, weight decay
    cfg.gnn.train.wd = 0.0
    # Dropout rate
    cfg.gnn.train.dropout = 0.5     # 0.0
    # k neighbors in graph construction
    cfg.gnn.train.K = 100
    ...
    cfg.lm.model = CN()
    # LM model name
    cfg.lm.model.name = 'intfloat/e5-mistral-7b-instruct' # 'microsoft/deberta-base'
    ...
    # Base learning rate
    cfg.lm.train.lr = 0.0001  # 2e-5  0.1  0.01
    # Maximal number of epochs
    ...
    cfg.lm.train.GSL_data_split = True
